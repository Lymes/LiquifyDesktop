...
- (void)setupControls
{
    ...
    self.metalController.followMousePointer = [[NSUserDefaults standardUserDefaults] boolForKey:kFollowMousePointer];
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
    ...
    {
        self.metalController.generateRandomDrops = value;
    }
    else if ( [keyPath isEqualToString:kFollowMousePointer] )
    {
        self.metalController.followMousePointer = value;
    }
